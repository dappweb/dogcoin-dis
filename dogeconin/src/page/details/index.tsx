  ...
  return (
    <div className="details-main-container">
      ...
      <div className="details-tabs-container">
        <div className="details-tabs-scroll">
          <div 
            className="details-tab-item"
            onClick={() => navigate("/details")}
          >
            <div className="details-rectangle-backup active" />
          ...
          >
            <div className="details-rectangle-backup-2" />
          ...
          >
            <div className="details-rectangle-backup-3" />
          ...
          >
            <div className="details-rectangle-backup-4" />
            <span className="details-association-rewards">Community rewards</span>
          </div>
        </div>
      </div>
