...
export default function Share() {
  ...
  return (
    <div className="share-main-container">
      ...
      <div className="share-tabs-container">
        <div className="share-tabs-scroll">
          <div 
            className="share-tab-item"
            onClick={() => navigate("/details")}
          >
            <div className="share-rectangle-backup" />
          ...
          >
            <div className="share-rectangle-backup-2 active" />
          ...
          >
            <div className="share-rectangle-backup-3" />
          ...
          >
            <div className="share-rectangle-backup-4" />
            <span className="share-association-rewards">Community rewards</span>
          </div>
        </div>
      </div>
