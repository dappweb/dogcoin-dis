  ...
  return (
    <div className="home-main-container">
      ...
      <div className="home-flex-row-ffaa">
        ...
        <div className="home-rectangle-b">
      ...
      <div className="home-flex-row-af">
        <div className="home-rectangle-f" />
        <div className="home-group-10">
          <span className="home-community-incentive">
            Community Incentive Program
          </span>
          <span className="home-innovation-and-integration">
            Innovation and integration lead the future
          </span>
        </div>
      ...
      <div className="home-flex-row-c">
        <div className="home-rectangle-14">
