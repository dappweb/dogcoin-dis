    ...
    <div className="team-main-container">
      ...
      <div className="team-tabs-container">
        <div className="team-tabs-scroll">
          ...
          >
            <div className="team-rectangle-backup" />
            <span className="team-static-income">Static income</span>
          </div>
          ...
          >
            <div className="team-rectangle-backup-1" />
            <span className="team-sharing-rewards">Sharing rewards</span>
          </div>
          ...
          >
            <div className="team-rectangle-backup-2 active" />
          ...
          >
            <div className="team-rectangle-backup-3" />
